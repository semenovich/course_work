...
<nav class="navbar navbar-default " role="navigation">
    <div class="container-fluid backgr">
        ...
        <div>
            ...
            <form class="navbar-form navbar-left" method="post" action="/project/servlet">
                <input type="hidden" name="action" value="readAllCarAndOrder"/>
                <div class="form-group">
                    <button type="submit" class="btn btn-default">Работа с автомобилями</button>
                </div>
            </form>
            <form class="navbar-form navbar-left" method="post" action="/project/servlet">
                <input type="hidden" name="action" value="readAllOrder"/>
                <div class="form-group">
                    <button type="submit" class="btn btn-default">Работа с заказами</button>
                </div>
            </form>
            <form class="navbar-form navbar-left" method="post" action="/project/servlet">
                <input type="hidden" name="action" value="profitAnalysis"/>
                <div class="form-group">
                    <button type="submit" class="btn btn-default">Аналитика</button>
                </div>
            </form>
